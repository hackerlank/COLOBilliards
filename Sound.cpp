...
{
	{"data/BGM/旅の終わり.wav", true},			// 通常BGM
	{"data/BGM/Clock.wav", true},				// 時の巻き戻し
	{"data/BGM/earth.wav", true},				// 地響き
	{"data/SE/衝突.wav", false},		// 
	{"data/SE/落下.wav", false},		// キャンセル音
};
///////////////////////////////////////////////////////////////////////////////
// プロトタイプ宣言
///////////////////////////////////////////////////////////////////////////////
...
// 音量をセット
///////////////////////////////////////////////////////////////////////////////
void Sound::SetVolume(SOUND_LABEL label,float vol)
{
	XAUDIO2_VOICE_STATE xa2state;
	...
	if(xa2state.BuffersQueued != 0)
	{// 再生中
		m_apSourceVoice[label]->SetVolume(vol);
	}
